...
$descriptionPrestationAccueil1 = $connexion->prepare('SELECT prestation_contenu FROM prestation ORDER BY prestation_libelle ASC LIMIT 1');
...
$descriptionPrestationAccueil2 = $connexion->prepare('SELECT prestation_contenu FROM prestation ORDER BY prestation_libelle ASC LIMIT 1, 2');
...
$descriptionPrestationAccueil3 = $connexion->prepare('SELECT prestation_contenu FROM prestation ORDER BY prestation_libelle ASC LIMIT 2, 3');
...
$descriptionPrestationAccueil4 = $connexion->prepare('SELECT prestation_contenu FROM prestation ORDER BY prestation_libelle ASC LIMIT 3, 4');
...
$nomPartenaireAccueil1 = $connexion->prepare('SELECT part_libelle FROM partenaire ORDER BY part_id DESC LIMIT 1');
...
$nomPartenaireAccueil2 = $connexion->prepare('SELECT part_libelle FROM partenaire ORDER BY part_id DESC LIMIT 1, 2');
...
$nomPartenaireAccueil3 = $connexion->prepare('SELECT part_libelle FROM partenaire ORDER BY part_id DESC LIMIT 3, 4');
...
$nomPartenaireAccueil4 = $connexion->prepare('SELECT part_libelle FROM partenaire ORDER BY part_id DESC LIMIT 4, 5');
...
$descriptionPartenaireAccueil1 = $connexion->prepare('SELECT part_descriptif FROM partenaire ORDER BY part_id DESC LIMIT 1');
...
$descriptionPartenaireAccueil2 = $connexion->prepare('SELECT part_descriptif FROM partenaire ORDER BY part_id DESC LIMIT 1, 2');
...
$descriptionPartenaireAccueil3 = $connexion->prepare('SELECT part_descriptif FROM partenaire ORDER BY part_id DESC LIMIT 2, 3');
...
$descriptionPartenaireAccueil4 = $connexion->prepare('SELECT part_descriptif FROM partenaire ORDER BY part_id DESC LIMIT 3, 4');
...
<body>
        ...
        <div class="s2">
            ...
            <div class="home-prestation-mere">
                ...
                <div class="home-prestation-btn">
                    <a class="button-36" href="./prestation/prestation.php">voir plus</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="partenaire">
            ...
            <a class="button-36 bouton-partenaire-commentaire" href="./partenaire/partenaire.php">Voir plus de partenaires</a>
        </div>
